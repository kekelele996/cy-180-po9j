...
func statusOf(code int) int {
	...
	case constants.CodeConflict, constants.CodeDuplicateName, constants.CodeProjectStatus, constants.CodeRecordingStatus, constants.CodeMarkerConflict, constants.CodeReviewStatus:
