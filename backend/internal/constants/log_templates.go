...
const (
	...
	LogReviewSubmit        = "recording review submit by=%s recording=%d from=%s to=%s"
	LogReviewApprove       = "recording review approve by=%s recording=%d summary=%s"
	LogReviewReject        = "recording review reject by=%s recording=%d comment=%s"
